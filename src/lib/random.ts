...
// Originally from https://github.com/joepie91/node-random-number-csprng
...
class RandomGenerationError extends Error {
  ...
  constructor(message: string) {
    ...
    this.code = "RandomGenerationError";
  }
}
...
export async function secureRandomNumber(minimum: number, maximum: number): Promise<number> {
